...
class _UpdatePageState extends State<UpdatePage> {
  void UpdatePage() async {
    String url = "http://10.0.2.2:3000/wngine/update";
    String json = jsonEncode(
      {
        "name": name.text,
        "price": price.text.toString(),
        "rarityGUN": rarityGUN.text,
        "baseATK": baseATK.text.toString(),
        "baseAdvStat": baseAdvStat.text,
        "description": description.text,
        "typeID": typeID.text.toString(),
        "level": level.text.toString(),
        "wNgineID": wNgineID.text.toString(),
        "gun_image": gun_image != null ? base64Encode(gun_image!) : null,
      },
    );
    ...
    if (response.statusCode == 200) {
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text('Success update data!')));
  ...
  var wNgineID = TextEditingController();
  Uint8List? gun_image;
